  ...
  <body>
    ...
    <div class="container gc-footer">
      <div class="col-md-4 gc-built-with">
        ...
        <img class="img-responsive pull-left" src="/img/laravel.png" />
        <img class="img-responsive pull-left" src="/img/html5.png" />
        <img class="img-responsive pull-left" src="/img/bootstrap.png" />
        <div style="clear:both"></div>
      </div>
      <div class="col-md-3 gc-connect">
        <h3>Connect</h3>
        <div class="gc-content-divider"></div>
        <a href="http://www.linkedin.com/pub/greg-considine/60/384/710"><img class="img-responsive pull-left" src="/img/linkedin.png" /></a>
        <a href="https://github.com/gconsidine"><img class="img-responsive pull-left" src="/img/github.png" /></a>
        <div style="clear:both"></div>
      </div>
