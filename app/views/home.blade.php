...
<div id="webApps" class="container">
  <div class="gc-content">
    <div class="col-md-4 gc-icon-title">
      ...
      <h1>Web Apps</h1>
      <span class="glyphicon glyphicon-question-sign gc-content-details" data-toggle="modal" data-target="#webAppsModal"></span>
    </div>
    <div class="col-md-8">
...
<div id="canvasAnimations" class="container">
  <div class="gc-content">
    <div class="col-md-4 gc-icon-title">
      ...
      <span class="glyphicon glyphicon-question-sign gc-content-details" data-toggle="modal" data-target="#canvasModal"></span>
    </div>
    <div class="col-md-8">
      <div class="gc-image-container">
...
<!-- Modals -->
<div class="modal fade" id="webAppsModal" tabindex="-1" role="dialog" aria-labelledby="webAppsModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="gc-project-entry">
          ...
          <p>Built with Laravel (an MVC framework for PHP) and Twitter Bootstrap (for responsive design). The site has CMS features that gives an administrator the ability to add/edit/delete articles, blogs, events, clients, and other information throughout the site. All content is automatically formatted and displayed.</p>
        </div>
        <div class="gc-project-entry">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="gc-project-entry">
          ...
          <p>I took a different approach to <em>Forest Moon</em> from my other animations, but I was still bound by the same time constraints in the course so I wasn't able to add in the detail I originally planned. I layered three canvas elements: one layer for the orbiting sun and moon (the moon also transitions through its phases every 28 periods), one layer for the randomly placed (within particular parameters) terrestrial elements, and one layer for actors -- though the only actor ended up being a triangular UFO-thing.</p>
        </div>
        <div class="gc-project-entry">
